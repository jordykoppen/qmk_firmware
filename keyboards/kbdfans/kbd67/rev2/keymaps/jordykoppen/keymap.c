...
[0] = LAYOUT_65_ansi(
  ...
  KC_LSFT,          KC_Z,    KC_X,   KC_C,   KC_V,   KC_B,   KC_N,   KC_M,   KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_RCTL,  KC_END,
...
[2] = LAYOUT_65_ansi(
  ...
  KC_LSFT,          KC_Z,    KC_X,   KC_C,   KC_V,   KC_B,   KC_N,   KC_M,   KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_RCTL,  KC_END,
  KC_LCTL, KC_LALT, KC_LGUI,                KC_SPC,                          TO(0), KC_RALT,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
)
};
