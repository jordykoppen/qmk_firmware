...
/* Keymap (Base Layer) Default Layer
   ...
   * |----------------------------------------------------------------|
   * |Ctrl|Win |Alt |        Space          |Alt| FN| Lef|Dow| Up|Rig |
   * `----------------------------------------------------------------'
   */
[0] = LAYOUT_65_ansi(
  ...
  KC_LCTL, KC_LALT, KC_LGUI,                KC_SPC,                          KC_RALT, MO(1),   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
[1] = LAYOUT_65_ansi(
  ...
  _______, _______, KC_UP,   _______, RESET, _______, _______, _______, KC_PSCR, KC_SLCK, KC_PAUS, KC_UP,   _______, _______, _______,
